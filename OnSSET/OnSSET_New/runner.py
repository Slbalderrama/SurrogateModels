...
if choice == 1:
    ...
    for scenario in Scenarios:
        ...
        mg_hybrid.deep_of_Discharge = ScenarioParameters.iloc[0]['Deep of Discharge']
        mg_hybrid.battery_cycles = ScenarioParameters.iloc[0]['Battery Cycles']
        mg_hybrid.generator_efficiency = ScenarioParameters.iloc[0]['Generator Efficiency']
        mg_hybrid.low_heating_value =  ScenarioParameters.iloc[0]['Low Heating Value']
        ...
        for year in yearsofanalysis:
            ...
            onsseter.calculate_off_grid_lcoes(sa_pv_calc, sa_diesel_calc, year, start_year, end_year, time_step)
            ...
            onsseter.results_columns(sa_pv_calc, sa_diesel_calc, grid_calc, mg_hybrid, year)

            onsseter.calculate_investments(sa_pv_calc, sa_diesel_calc, grid_calc, mg_hybrid,year, end_year, time_step)

            onsseter.apply_limitations(eleclimit, year, time_step, prioritization)

            onsseter.final_decision(sa_pv_calc, sa_diesel_calc, grid_calc, mg_hybrid, year, end_year, time_step)

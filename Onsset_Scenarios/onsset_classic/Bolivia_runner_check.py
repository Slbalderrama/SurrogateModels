...
Base_To_Peak_MG_PV_1 = Base_To_Peak_MG_PV.loc[Base_To_Peak_MG_PV['Base_To_Peak_Ratio']!= 0.9]
Base_To_Peak_MG_Diesel_1 = Base_To_Peak_MG_Diesel.loc[Base_To_Peak_MG_Diesel['Base_To_Peak_Ratio'] != 0.5]
...
comparation4 = df1.index == Base_To_Peak_MG_PV_1.index
print(comparation4.all())

comparation5 = df1.index == Base_To_Peak_MG_PV_1.index
print(comparation5.all())

...
lm1 = lm1.fit(X, y)    
dump(lm1, 'Demand_LowLands.joblib')  
#%%
...
Results['Demand'] = pd.DataFrame(lm1.predict(x))[0] 
e = 0.12
y=20
...
Results['Demand_Discounted'] = Results['Demand']/CFR
...
Results1['Demand_Discounted 1'] = pd.DataFrame(lm1.predict(x))[0]/CFR 
